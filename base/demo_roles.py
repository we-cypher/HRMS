...
DEMO_ROLE_ASSIGNMENTS = (
    ("alexander.smith@wecypher.com", "Asset Manager", "Your Company"),
    ("alexander.smith@wecypher.com", "Asset Manager", "Your Company Inc."),
    ("michael.brown@wecypher.com", "HR Manager", "Your Company"),
    ("sarah.anderson@wecypher.com", "Payroll Manager", "Your Company"),
    ("emily.clark@wecypher.com", "Leave Manager", "Your Company"),
    ("jessica.evans@wecypher.com", "Attendance Manager", "Your Company"),
    ("benjamin.parker@wecypher.com", "Recruiter", "Your Company Ltd."),
    ("lily.campbell@wecypher.com", "Helpdesk Agent", "Your Company Inc."),
    ("matthew.harris@wecypher.com", "Performance Manager", "Your Company"),
    ("david.king@wecypher.com", "Project Manager", "Your Company"),
)
